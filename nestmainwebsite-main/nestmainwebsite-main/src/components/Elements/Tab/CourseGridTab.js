                        ...
                        <div className="row">

                            {
                                props.items.map((item) => ( 
                                          ...
                                          <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6" data-id={item.id}>
                                          <div className="course__item white-bg mb-30 fix">
                                              ...
                                              <div className="course__content">
                                                  ...
                                                  <h3 className="course__title"><Link  href={{ pathname: "/course-details", query: { id: item.id } }}><a>{item.name}</a></Link></h3>
                                              ...
                                              <div className="course__more d-flex justify-content-between align-items-center">
                                                  ...
                                                  <div className="course__btn">
                                                      <Link
                                                      href={{ pathname: "/course-details", query: { id: item.id } }}>
